...
#define STR_NI(NSInteger)     [NSString stringWithFormat:@"%ld",NSInteger]


#define kDateFormat  @"yyyy'-'MM'-'dd'T'HH':'mm':'ss'Z"
#define bDateFormat  @"yyyy'-'MM'-'dd"
#define tDateFormat  @"yyyy-MM-dd HH:mm"

/*club notificationName*/
#define ClubActiveCreateSucess @"ClubActiveCreateSucess"
