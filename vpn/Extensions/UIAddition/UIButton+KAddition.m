...
+(UIButton*)buttonWithFrame:(CGRect)frame backgroundColor:(UIColor *)color title:(NSString *)title font:(UIFont *)font titleColor:(UIColor *)titleColor hlTitleColor:(UIColor *)hlTitleColor onTapBlock:(ButtonActionBlock)block
{
    KUIButton *btn = [[KUIButton alloc] initWithFrame:frame];
